...
with open('poly_1.txt') as file:
    p1 = file.readline()
  
with open('poly_2.txt') as file:
    p2 = file.readline()
...
with open('poly_3.txt', 'w') as file:
    file.write(f'{res}=0') # функция print_poly ничего не возвращает и поэтому в третий файл записался только None. Как сделать эту функцию возвратной?
